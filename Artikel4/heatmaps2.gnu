...
unset colorbox 
plot 'origData.csv'  matrix  with image pixels notitle,\
	'significane2_orig_transposed.dat' @pointStyle
...
plot 'invData.csv' matrix with image pixels notitle,\
	'significane2_inv_transposed.dat' @pointStyle