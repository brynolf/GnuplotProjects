...
set output 'heatmapDualPlotNew.tex'
...
plot 'heatmapKSPresentation_textureResultsProstate.bin' binary array=(4,19) format='%double' rotate=pi transpose flip=xy with image notitle,\
'significantKSPresentation_textureResultsProstate.dat' @pointStyle