...
set output 'heatmapDualPlotNormalizedAnova.tex'
...
unset colorbox 
plot 'heatmapAnova_NormalizedTextureResults.bin' binary array=(5,19) format='%double' rotate=pi transpose flip=xy with image notitle,\
'significantAnova_NormalizedTextureResults.dat' @pointStyle
...
plot 'heatmapAnova_NormalizedTextureResultsProstate.bin' binary array=(4,19) format='%double' rotate=pi transpose flip=xy with image notitle,\
'significantAnova_NormalizedTextureResultsProstate.dat' @pointStyle