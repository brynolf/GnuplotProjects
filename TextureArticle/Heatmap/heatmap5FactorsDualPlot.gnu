...
set output 'heatmap5FactorsDualPlot.tex'
...
plot 'heatmap_original_coefficients.bin' binary array=(19,49) format='%double' rotate=pi transpose flip=xy with image notitle,\
	...
	'significant_original_coefficients.dat' @pointStyle

	
## Plot Second graph
unset arrow 1
unset arrow 2
set title '(b) MLR coefficients, normalized'
...
plot 'heatmap_Coefficients_normalized.bin' binary array=(19,49) format='%double' rotate=pi transpose flip=xy with image notitle,\
	...
	33.5 with lines dt 3 lt rgb "#000000" notitle,\
	36.5 with lines dt 3 lt rgb "#000000" notitle,\
	'significant_Coefficients_normalized.dat' @pointStyle