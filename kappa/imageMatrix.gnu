...
set title 'Features'
plot 'contrast8bit.dat' using 1:2 with lines ls 1 notitle,\
	'energy8bit.dat' using 1:2 with lines ls 2 notitle,\
	'entropy8bit.dat' using 1:2 with lines ls 3 notitle,\
	'homogeneity8bit.dat' using 1:2 with lines ls 4 notitle,\
	'autocorrelation8bit.dat' using 1:2 with lines ls 5 notitle
...
set lmargin at screen lbuffer+2*hbuffer+2*imgwidth
set rmargin at screen lbuffer+2*hbuffer+imgwidth*3
plot 'contrast128bit.dat' using 1:2 with lines ls 1 notitle,\
	'energy128bit.dat' using 1:2 with lines ls 2 notitle,\
	'entropy128bit.dat' using 1:2 with lines ls 3 notitle,\
	'homogeneity128bit.dat' using 1:2 with lines ls 4 notitle,\
	'autocorrelation128bit.dat' using 1:2 with lines ls 5 notitle
...
plot 'contrast10k.dat' using 1:2 with lines ls 1  notitle,\
	...
	'autocorrelation30k.dat' using 1:2 with lines ls 5 notitle
...
set lmargin at screen lbuffer+1*hbuffer+1*imgwidth
set rmargin at screen lbuffer+1*hbuffer+imgwidth*2
plot 'contrast30k.dat' using 1:2 with lines ls 1 title 'Contrast',\
	'energy30k.dat' using 1:2 with lines ls 2 title 'Energy',\
	'entropy30k.dat' using 1:2 with lines ls 3 title 'Entropy',\
	'homogeneity30k.dat' using 1:2 with lines ls 4 title 'Homogen.',\
	'autocorrelation30k.dat' using 1:2 with lines ls 5 title 'Autocorr.'
